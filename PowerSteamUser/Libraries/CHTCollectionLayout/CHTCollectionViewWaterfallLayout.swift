...
@objc public protocol CHTCollectionViewDelegateWaterfallLayout: UICollectionViewDelegate {
    ...
    func collectionView (_ collectionView: UICollectionView, layout collectionViewLayout: UICollectionViewLayout,
                         sizeForItemAtIndexPath indexPath: IndexPath, itemWidth: CGFloat) -> CGSize
    ...
    override public func prepare() {
        ...
        for section in 0 ..< numberOfSections {
            ...
            for idx in 0 ..< itemCount {
                ...
                let itemSize = self.delegate?.collectionView(self.collectionView!, layout: self, sizeForItemAtIndexPath: indexPath, itemWidth: itemWidth)
